...
<!-- generated with COPASI 4.23 (Build 184) (http://www.copasi.org) at 2020-05-06 10:12:03 UTC -->
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  ...
  <Model key="Model_1" name="Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10" simulationType="time" timeUnit="d" volumeUnit="1" areaUnit="m²" lengthUnit="m" quantityUnit="#" type="deterministic" avogadroConstant="6.0221408570000002e+23">
    <MiriamAnnotation>
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_1">
    ...
    <Comment>
      Wff1Corona_Lux_2020-03-20_1340 intermittentGwork full lockdown effect of socialdistancing Fig 3 also Fig 2WORK2C.  This shows model for social distancing factor of 10, which is taken to represent a complete lockdown.
    </Comment>
  ...
  <celldesigner:listOfModification>
    <celldesigner:modification type="CATALYSIS" modifiers="s22" aliases="sa10" targetLineIndex="-1,4" editPoints="-0.02817442596291808,-0.011469491956719868 0.19116888845642027,-0.5502790570088124 1.0771813241170358,-0.1895933586475348">
      ...
      <celldesigner:line width="3.0" color="ffff6699" />
        ...
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default]">
  ...
  <celldesigner:listOfModification>
    <celldesigner:modification type="CATALYSIS" modifiers="s29" aliases="sa14" targetLineIndex="-1,2">
      ...
      <celldesigner:line width="3.0" color="ffff3366" />
        ...
        <KineticLaw function="Function_40" unitType="Default" scalingCompartment="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default]">
          <ListOfCallParameters>
      ...
      <rdf:Description>
        ...
        <ListOfAssignments>
          <Assignment targetKey="ModelValue_17">
            <Expression>
              &lt;CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[n_lockdowns],Reference=Value>+1
            </Expression>
          </Assignment>
        </ListOfAssignments>
      </Event>
    ...
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfAssignments>
          <Assignment targetKey="ModelValue_12">
            <Expression>
              &lt;CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Social_Distance],Reference=InitialValue>
            </Expression>
          </Assignment>
        </ListOfAssignments>
      </Event>
  ...
  <rdf:Description rdf:about="#Event_3">
    <dcterms:created>
      <rdf:Description>
        ...
        <TriggerExpression>
          &lt;CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[infected-nontested],Reference=Concentration> &lt; 0
        </TriggerExpression>
        <ListOfAssignments>
  ...
  <rdf:Description rdf:about="#Event_4">
    <dcterms:created>
      <rdf:Description>
        ...
        <TriggerExpression>
          &lt;CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[symptoms-nontested],Reference=Concentration> &lt; 0
        </TriggerExpression>
        <PriorityExpression>
          &lt;CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[symptoms-nontested],Reference=Concentration>
        </PriorityExpression>
        <ListOfAssignments>
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Event_5">
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_1">
      <ModelParameterSet key="ModelParameterSet_1" name="Initial State">
        <ModelParameterGroup cn="String=Initial Time" type="Group">
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10" value="0" type="Model" simulationType="time"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Compartment Sizes" type="Group">
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default]" value="1" type="Compartment" simulationType="fixed"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[infected-nontested]" value="2" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[infected-tested]" value="1" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[uninfected_non-tested]" value="630000" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[uninfected-tested]" value="0" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[symptoms-tested]" value="0" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[symptoms-nontested]" value="0" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[recovered-tested]" value="0" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[recovered-nontested]" value="0" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[S]" value="1" type="Species" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[Corona-dead-tested]" value="0" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[Corona-dead-nontested]" value="0" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[non-corona-dead]" value="0" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[total population]" value="630003" type="Species" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[Corona-registered]" value="1" type="Species" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[% corona dead]" value="0" type="Species" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[%corona recovered]" value="0" type="Species" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[% non corona dead]" value="0" type="Species" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[corona dead / all dead (%)]" value="NaN" type="Species" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[epidemic extinguished]" value="0" type="Species" simulationType="fixed"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Testing_Randome]" value="0.00080000000000000004" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Total_Infection_coefficient]" value="1.9468861043575834e-06" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Normal_death rate constant]" value="3.29e-05" type="ModelValue" simulationType="fixed">
            <InitialExpression>
              3.29e-05
            </InitialExpression>
          </ModelParameter>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Corona_death_rate_constant]" value="0.002" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Birth_rate]" value="3.29e-05" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Testing_for_Symptoms]" value="500" type="ModelValue" simulationType="fixed">
            <InitialExpression>
              500
            </InitialExpression>
          </ModelParameter>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Corona_recover]" value="0.067000000000000004" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Symptoms_appear]" value="0.30164999999999997" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Infection_from_non-tested_no-symptoms]" value="0.50800000000000001" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Infection_from_non-tested_symptoms]" value="0.25" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Infection_from_tested_no-symptoms]" value="0.025000000000000001" type="ModelValue" simulationType="fixed">
            <InitialExpression>
              0.025
            </InitialExpression>
          </ModelParameter>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Infection_from_tested_symptoms]" value="0.025000000000000001" type="ModelValue" simulationType="fixed">
            <InitialExpression>
              0.025
            </InitialExpression>
          </ModelParameter>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Social_Distance]" value="534700" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Government_induced_isolation_factor]" value="10" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Time_government_action]" value="15" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[lockdown duration]" value="730" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[lockdown pause duration]" value="7" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[n_lockdowns]" value="0" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[n_pauses]" value="0" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[intermittent time]" value="0" type="ModelValue" simulationType="assignment"/>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[time fraction lock down]" value="0.5" type="ModelValue" simulationType="fixed">
            <InitialExpression>
              0.5*0.7/0.5*0.65/0.7*1/0.65*0.5
            </InitialExpression>
          </ModelParameter>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[number cutoff]" value="0" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[symptomatic number tolerance]" value="141" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[government response factor to diagnosed infected]" value="0" type="ModelValue" simulationType="fixed"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          <ModelParameterGroup cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Reactions[re1]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Reactions[re1],ParameterGroup=Parameters,Parameter=k1" value="1.9468861043575834e-06" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Total_Infection_coefficient],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Reactions[re2]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Reactions[re2],ParameterGroup=Parameters,Parameter=k1" value="0.00080000000000000004" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Testing_Randome],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Reactions[re3]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Reactions[re3],ParameterGroup=Parameters,Parameter=k1" value="1.9468861043575834e-06" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Total_Infection_coefficient],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Reactions[re4]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Reactions[re4],ParameterGroup=Parameters,Parameter=k1" value="0.00080000000000000004" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Testing_Randome],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Reactions[re5]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Reactions[re5],ParameterGroup=Parameters,Parameter=k1" value="0.30164999999999997" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Symptoms_appear],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Reactions[re6]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Reactions[re6],ParameterGroup=Parameters,Parameter=k1" value="0.30164999999999997" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Symptoms_appear],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Reactions[re7]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Reactions[re7],ParameterGroup=Parameters,Parameter=k1" value="500" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Testing_for_Symptoms],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Reactions[re8]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Reactions[re8],ParameterGroup=Parameters,Parameter=k1" value="0.002" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Corona_death_rate_constant],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Reactions[re9]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Reactions[re9],ParameterGroup=Parameters,Parameter=k1" value="0.067000000000000004" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Corona_recover],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Reactions[re10]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Reactions[re10],ParameterGroup=Parameters,Parameter=k1" value="0.067000000000000004" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Corona_recover],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Reactions[re11]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Reactions[re11],ParameterGroup=Parameters,Parameter=k" value="3.29e-05" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Birth_rate],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Reactions[re12]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Reactions[re12],ParameterGroup=Parameters,Parameter=k1" value="3.29e-05" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Normal_death rate constant],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Reactions[re13]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Reactions[re13],ParameterGroup=Parameters,Parameter=k1" value="3.29e-05" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Normal_death rate constant],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Reactions[re14]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Reactions[re14],ParameterGroup=Parameters,Parameter=k1" value="3.29e-05" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Normal_death rate constant],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Reactions[re15]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Reactions[re15],ParameterGroup=Parameters,Parameter=k1" value="0.002" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Corona_death_rate_constant],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Reactions[re16]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Reactions[re16],ParameterGroup=Parameters,Parameter=k1" value="0.002" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Corona_death_rate_constant],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Reactions[re17]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Reactions[re17],ParameterGroup=Parameters,Parameter=k1" value="3.29e-05" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Normal_death rate constant],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Reactions[re18]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Reactions[re18],ParameterGroup=Parameters,Parameter=k1" value="0.002" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Corona_death_rate_constant],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
    ...
    <InitialState type="initialState">
      0 2 0 0 0 630000 1 0 0 0 0 0 630003 1 0 0 0 NaN 1.9468861043575834e-06 10 0 1 0 1 0.00080000000000000004 3.29e-05 0.002 3.29e-05 500 0.067000000000000004 0.30164999999999997 0.50800000000000001 0.25 0.025000000000000001 0.025000000000000001 534700 15 730 7 0 0 0.5 0 141 0 
    </InitialState>
  </Model>
  <ListOfTasks>
    ...
    <PlotSpecification name="Infection_coefficient" type="Plot2D" active="1" taskTypes="">
      ...
      <ListOfPlotItems>
        <PlotItem name="Values[Total_Infection_coefficient]|Time" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Total_Infection_coefficient],Reference=Value"/>
          </ListOfChannels>
        </PlotItem>
      </ListOfPlotItems>
    </PlotSpecification>
    <PlotSpecification name="times" type="Plot2D" active="1" taskTypes="">
      ...
      <ListOfPlotItems>
        ...
        <PlotItem name="Values[Government_induced_isolation]|Time" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Government_induced_isolation_factor],Reference=Value"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="Values[Social_Distance]|Time" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[Social_Distance],Reference=Value"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="Values[intermittent time]|Time" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[intermittent time],Reference=Value"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="Values[n_lockdowns]|Time" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Values[n_lockdowns],Reference=Value"/>
          </ListOfChannels>
        </PlotItem>
      </ListOfPlotItems>
    </PlotSpecification>
    <PlotSpecification name="plot all" type="Plot2D" active="1" taskTypes="">
      ...
      <ListOfPlotItems>
        ...
        <PlotItem name="[% corona dead]|Time" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[% corona dead],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[% non corona dead]|Time" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[% non corona dead],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[%corona recovered]|Time" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[%corona recovered],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[Corona-dead-nontested]|Time" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[Corona-dead-nontested],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[Corona-dead-tested]|Time" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[Corona-dead-tested],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[Corona-registered]|Time" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[Corona-registered],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[S]|Time" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[S],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[Uninfected_non-tested]|Time" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[uninfected_non-tested],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[corona dead / all dead (%)]|Time" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[corona dead / all dead (%)],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[epidemic extinguished]|Time" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[epidemic extinguished],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[infected-nontested]|Time" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[infected-nontested],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[infected-tested]|Time" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[infected-tested],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[non-corona-dead]|Time" type="Curve2D">
          <Parameter name="Line type" type="unsignedInteger" value="0"/>
        ...
        <PlotItem name="[recovered-nontested]|Time" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[recovered-nontested],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[recovered-tested]|Time" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[recovered-tested],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[symptoms-nontested]|Time" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[symptoms-nontested],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[symptoms-tested]|Time" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[symptoms-tested],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[total population]|Time" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[total population],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[uninfected-tested]|Time" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown Figure 2 for social distancing of 10,Vector=Compartments[default],Vector=Metabolites[uninfected-tested],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
      </ListOfPlotItems>
    </PlotSpecification>
