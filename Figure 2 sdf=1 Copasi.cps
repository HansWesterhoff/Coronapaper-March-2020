...
<!-- generated with COPASI 4.23 (Build 184) (http://www.copasi.org) at 2020-03-25 22:00:11 UTC -->
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_1">
      <ModelParameterSet key="ModelParameterSet_1" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown,Vector=Values[Government_induced_isolation_factor]" value="1" type="ModelValue" simulationType="assignment"/>
          ...
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown,Vector=Values[lockdown duration]" value="730" type="ModelValue" simulationType="fixed"/>
          ...
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown,Vector=Values[number cutoff]" value="0" type="ModelValue" simulationType="fixed"/>
          ...
          <ModelParameter cn="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown,Vector=Values[government response factor to diagnosed infected]" value="0" type="ModelValue" simulationType="fixed"/>
        </ModelParameterGroup>
  ...
  <GUI>
    <ListOfSliders>
      ...
      <Slider key="Slider_1" associatedEntityKey="Task_15" objectCN="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown,Vector=Values[Government_induced_isolation_factor],Reference=InitialValue" objectType="float" objectValue="1" minValue="0" maxValue="25" tickNumber="1000" tickFactor="100" scaling="linear"/>
      ...
      <Slider key="Slider_6" associatedEntityKey="Task_15" objectCN="CN=Root,Model=Corona model of extinguishable epidemic with limited time incomplete lockdown,Vector=Values[Symptoms_appear],Reference=InitialValue" objectType="float" objectValue="0.30165" minValue="0.15" maxValue="0.6" tickNumber="1000" tickFactor="100" scaling="linear"/>
    </ListOfSliders>
  </GUI>
